...
%%
<YYINITIAL> {
  \b(if|else|while|for|do|break|continue|return|class|struct|int|string|bool|float|char|true|false|func|Console|WriteLine|Write|switch|case|default)\b { return DreamTokenTypes.KEYWORD; }
