...
%%
<YYINITIAL> {
  \b(if|else|while|for|do|break|continue|return|int|string|bool|float|true|false|func|Console|WriteLine|Write|switch|case|default)\b { return DreamTokenTypes.KEYWORD; }
