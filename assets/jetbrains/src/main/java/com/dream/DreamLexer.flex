...
%%
<YYINITIAL> {
  \b(if|else|while|for|do|break|continue|return|class|struct|new|int|string|bool|float|char|void|var|let|true|false|func|switch|case|default|Console|WriteLine|Write|ReadLine)\b { return DreamTokenTypes.KEYWORD; }
  ...
  \b[a-zA-Z_][a-zA-Z0-9_]* /\s*\( { return DreamTokenTypes.FUNCTION; }
